...
def point_cloud_three_views_with_keypoint(points, keypoints, pred=None):
    ...
    keypts_img1 = draw_point_cloud(keypoints, normalize=False, zrot=110/180.0*np.pi, xrot=45/180.0*np.pi, yrot=0/180.0*np.pi)
    keypts_img2 = draw_point_cloud(keypoints, normalize=False, zrot=70/180.0*np.pi, xrot=135/180.0*np.pi, yrot=0/180.0*np.pi)
    keypts_img3 = draw_point_cloud(keypoints, normalize=False, zrot=180.0/180.0*np.pi, xrot=90/180.0*np.pi, yrot=0/180.0*np.pi)
    ...
    if pred is not None:
        keypts_img1 = draw_point_cloud(pred, normalize=False, zrot=110/180.0*np.pi, xrot=45/180.0*np.pi, yrot=0/180.0*np.pi)
        keypts_img2 = draw_point_cloud(pred, normalize=False, zrot=70/180.0*np.pi, xrot=135/180.0*np.pi, yrot=0/180.0*np.pi)
        keypts_img3 = draw_point_cloud(pred, normalize=False, zrot=180.0/180.0*np.pi, xrot=90/180.0*np.pi, yrot=0/180.0*np.pi)
        keypts_image_large = np.concatenate([keypts_img1, keypts_img2, keypts_img3], 1)
        image[:,:,1] += keypts_image_large
        np.clip(image, 0, 1, image)
