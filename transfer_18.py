...
parser.add_argument('--model', default='pointnet_cls_rot_transfer', help='Model name: pointnet_cls or pointnet_cls_basic')
parser.add_argument('--log_dir', default='log_transfer_18', help='Log dir')
...
parser.add_argument('--model_path', default='log_rot_18/model.ckpt', help='model checkpoint file path')
...
def train():
    with tf.Graph().as_default():
        with tf.device('/gpu:'+str(GPU_INDEX)):
            ...
            # Get model and loss 
            pred, end_points = MODEL.get_model(pointclouds_pl, is_training_pl, is_training_base_pl, bn_decay=bn_decay)
