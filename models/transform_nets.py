...
def input_transform_net(point_cloud, is_training, bn_decay=None, K=3, is_edge_feature=False):
    ...
    input_image = tf.expand_dims(point_cloud, -1) #shape = (None, 1024, 3, 1)
...
def edge_feature_transform_net(edge_feature, is_training, bn_decay=None, K=3, is_dist=False):
    """ Input (XYZ) Transform Net, input is BxNx3 gray image
        Return:
            Transformation matrix of size 3xK """
