...
def get_model(point_cloud, is_training, num_angles=None, bn_decay=None, use_input_trans=False, use_feature_trans=False, num_classes=40):
	...
	net = tf_util.fully_connected(net, 512, bn=True, is_training=is_training,
									scope='transfer/fc1', bn_decay=bn_decay)
	net = tf_util.dropout(net, keep_prob=0.5, is_training=is_training,
							scope='transfer/dp1')
	net = tf_util.fully_connected(net, 256, bn=True, is_training=is_training,
									scope='transfer/fc2', bn_decay=bn_decay)
	net = tf_util.dropout(net, keep_prob=0.5, is_training=is_training,
							scope='transfer/dp2')
	net = tf_util.fully_connected(net, num_classes, activation_fn=None, scope='transfer/fc3')
